...
bug ou valider une connexion série sur le robot physique avant d'y
attacher ROS2.

Pour la simulation TCP contre le simulateur du protocole, utiliser
seekur_interactive_tcp.py à la place.
"""
